sap.ui.require(["sap/ui/test/Opa5", "sap/ui/test/actions/Press"], function (Opa5, Press) {
    ...
    const sViewName = "com.sap.sdishowpdf1.view.MainView";
            ...
            assertions: {
                ...
                iShouldSeeTheTitle: function () {
                    return this.waitFor({
                        ...
                        properties: {
                            text: "Title of com.sap.sdishowpdf1",
                        },
                        success: function () {
                            Opa5.assert.ok(true, "The page shows the correct title");
                        },
                        errorMessage: "App does not show the expected title com.sap.sdishowpdf1",
                    });
                },
            },
        },
